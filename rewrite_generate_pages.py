#!/usr/bin/env python3
"""
Script to generate the complete rewritten generate-pages.py file
"""

# This script will output the complete file content
output = []
...
print("Writing file header and base functions...")
with open('/Users/motta/Documents/GitHub/simulateur/generate-pages-NEW.py', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))
